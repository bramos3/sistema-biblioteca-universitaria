  ...
  <div class="flex">
    ...
    <div class="ml-64 w-full pt-16 p-6 min-h-[calc(100vh-4rem)] flex flex-col">
      ...
      <div class="flex-grow flex items-center justify-center">
        <form action="{{ route('newprestamo.store') }}" method="POST" class="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-8 w-full max-w-md">
        @csrf
          <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-6 text-center">Registrar Nuevo Prestamo</h2>
          ...
          <div class="mb-4">
            ...
            <input type="text" id="fecha_prestamo" name="fecha_prestamo" placeholder="2025-10-01" value="<?php echo date('Y-m-d'); ?>"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400" required />
          </div>
          ...
          <div class="mb-4">
            <label for="libro" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Codigo del Libro</label>
            <input type="libro" id="libro" name="codigo_libro" placeholder="stars wars"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400" required />
          </div>
